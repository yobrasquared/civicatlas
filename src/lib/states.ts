...
/** GEOID like "0612" -> { state: "CA", district: 12 }. Delegate codes 98/99 -> 0 (at-large). */
export function parseGeoid(geoid: string): { state: string; district: number } | null {
...
export function districtLabel(state: string, district: number): string {
